...
\begin{example}
    ...
    then 
    \[
    \sigma\cdot f=X_3X_1-X_2+5X_3X_1^2X_2.
    \]
...
%$(h,k^{-1})\cdot 1 = hk$. 
Note that the action of $L$ on $X$ is transitive, since for any $hk, h_1k_1\in X$ it holds that $(h_1h^{-1}, k_1^{-1}k)\cdot hk = h_1k_1$.
Since 
\[
