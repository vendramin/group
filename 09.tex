...
\begin{example}
    ...
    by permuting the variables. For example, for three variables, if 
    $\sigma=(123)$ and 
    \[
    ...
    \[
    \sigma\cdot 
    %f=X_2^2X_3-X_1+5X_2X_3^2X_1.
    f=X_3X_1-X_2+5X_3X_1^2X_2
    \]
...
\begin{exercise}
    Let a group $G$ act on a set $X$. Prove that 
...
\begin{optional}
Let $G$ be a group and $X$ and $Y$ be $G$-sets. 
