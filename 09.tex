...
Since $G=\langle (12),(123)\rangle$, one has the group
homomorphism 
$\rho\colon G\to\Sym_{X}$ given by $(12)\mapsto (x_2x_3)$, $(123)\mapsto (x_1x_2x_3)$.
\end{example}
...
\Longleftrightarrow g\in xHx^{-1}.
 \end{align*}
The subgroup $\ker\rho$ is called the \textbf{core} of $H$ in $G$. 
\end{example}
