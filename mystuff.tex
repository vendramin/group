...
%\DeclareEmphSequence{\bfseries\textcolor{magenta}}
\renewcommand\emph[1]{\textcolor{mymagenta}{\textbf{#1}}}
...
\newenvironment{bonus}
{\begin{tcolorbox}[boxrule=0pt,frame hidden,colback=yellow!55!white,
  left=.3em, right=.3em, top=-.2em, bottom=.3em,
  beforeafter skip balanced=.4\baselineskip plus 2pt,
  before upper={\parindent4mm\noindent},
