...
with $s>0$. Let $i_1\in\{1,\dots,n\}$ be such that 
        ...
        $\tau_j(i_1)\ne i_1$. Since the $\tau_k$'s commute, 
...
\begin{optional}
\section{Application: Block permutation cipher}
...
\section{Application: The 15-puzzle}

Probably, we are all familiar with the puzzle of Figure~\ref{fig:toy}. 

\begin{figure}[ht]
    \centering
%    \includegraphics[width=0.25\linewidth]{images/15puzzle.png}
    \input{images/15puzzle.tex}
...
this in a concrete example. We know that the 15-puzzle corresponds to the 
